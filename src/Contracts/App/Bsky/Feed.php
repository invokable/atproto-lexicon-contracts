...
interface Feed
{
    ...
    public const getActorLikesResponse = ['cursor' => 'string', 'feed' => [['post' => 'array', 'reply' => 'array', 'reason' => 'array', 'feedContext' => 'string', 'reqId' => 'string']]];
    public const getAuthorFeedResponse = ['cursor' => 'string', 'feed' => [['post' => 'array', 'reply' => 'array', 'reason' => 'array', 'feedContext' => 'string', 'reqId' => 'string']]];
    public const getFeedResponse = ['cursor' => 'string', 'feed' => [['post' => 'array', 'reply' => 'array', 'reason' => 'array', 'feedContext' => 'string', 'reqId' => 'string']]];
    ...
    public const getFeedSkeletonResponse = ['cursor' => 'string', 'feed' => [['post' => 'string', 'reason' => 'array', 'feedContext' => 'string']], 'reqId' => 'string'];
    public const getLikesResponse = ['uri' => 'string', 'cid' => 'string', 'cursor' => 'string', 'likes' => [['indexedAt' => 'string', 'createdAt' => 'string', 'actor' => 'array']]];
    public const getListFeedResponse = ['cursor' => 'string', 'feed' => [['post' => 'array', 'reply' => 'array', 'reason' => 'array', 'feedContext' => 'string', 'reqId' => 'string']]];
    ...
    public const getRepostedByResponse = ['uri' => 'string', 'cid' => 'string', 'cursor' => 'string', 'repostedBy' => [['did' => 'string', 'handle' => 'string', 'displayName' => 'string', 'description' => 'string', 'avatar' => 'string', 'associated' => 'array', 'indexedAt' => 'string', 'createdAt' => 'string', 'viewer' => 'array', 'labels' => 'array', 'verification' => 'array', 'status' => 'array']]];
    ...
    public const getTimelineResponse = ['cursor' => 'string', 'feed' => [['post' => 'array', 'reply' => 'array', 'reason' => 'array', 'feedContext' => 'string', 'reqId' => 'string']]];
