...
interface Actor
{
    ...
    public const getProfileResponse = ['did' => 'string', 'handle' => 'string', 'displayName' => 'string', 'description' => 'string', 'avatar' => 'string', 'banner' => 'string', 'followersCount' => 'int', 'followsCount' => 'int', 'postsCount' => 'int', 'associated' => 'mixed', 'joinedViaStarterPack' => ['uri' => 'string', 'cid' => 'string', 'record' => 'mixed', 'creator' => 'array', 'listItemCount' => 'int', 'joinedWeekCount' => 'int', 'joinedAllTimeCount' => 'int', 'labels' => 'array', 'indexedAt' => 'string'], 'indexedAt' => 'string', 'createdAt' => 'string', 'viewer' => 'mixed', 'labels' => [['ver' => 'int', 'src' => 'string', 'uri' => 'string', 'cid' => 'string', 'val' => 'string', 'neg' => 'bool', 'cts' => 'string', 'exp' => 'string', 'sig' => 'mixed']], 'pinnedPost' => ['uri' => 'string', 'cid' => 'string'], 'verification' => 'mixed'];
    public const getProfilesResponse = ['profiles' => [['did' => 'string', 'handle' => 'string', 'displayName' => 'string', 'description' => 'string', 'avatar' => 'string', 'banner' => 'string', 'followersCount' => 'int', 'followsCount' => 'int', 'postsCount' => 'int', 'associated' => 'array', 'joinedViaStarterPack' => 'array', 'indexedAt' => 'string', 'createdAt' => 'string', 'viewer' => 'array', 'labels' => 'array', 'pinnedPost' => 'array', 'verification' => 'array']]];
    public const getSuggestionsResponse = ['cursor' => 'string', 'actors' => [['did' => 'string', 'handle' => 'string', 'displayName' => 'string', 'description' => 'string', 'avatar' => 'string', 'associated' => 'array', 'indexedAt' => 'string', 'createdAt' => 'string', 'viewer' => 'array', 'labels' => 'array', 'verification' => 'array']], 'recId' => 'int'];
    public const searchActorsResponse = ['cursor' => 'string', 'actors' => [['did' => 'string', 'handle' => 'string', 'displayName' => 'string', 'description' => 'string', 'avatar' => 'string', 'associated' => 'array', 'indexedAt' => 'string', 'createdAt' => 'string', 'viewer' => 'array', 'labels' => 'array', 'verification' => 'array']]];
    public const searchActorsTypeaheadResponse = ['actors' => [['did' => 'string', 'handle' => 'string', 'displayName' => 'string', 'avatar' => 'string', 'associated' => 'array', 'viewer' => 'array', 'labels' => 'array', 'createdAt' => 'string', 'verification' => 'array']]];
