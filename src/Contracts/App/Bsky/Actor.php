...
interface Actor
{
    ...
    public const getSuggestionsResponse = ['cursor' => 'string', 'actors' => [['did' => 'string', 'handle' => 'string', 'displayName' => 'string', 'description' => 'string', 'avatar' => 'string', 'associated' => 'array', 'indexedAt' => 'string', 'createdAt' => 'string', 'viewer' => 'array', 'labels' => 'array', 'verification' => 'array', 'status' => 'array']], 'recId' => 'int'];
    public const searchActorsResponse = ['cursor' => 'string', 'actors' => [['did' => 'string', 'handle' => 'string', 'displayName' => 'string', 'description' => 'string', 'avatar' => 'string', 'associated' => 'array', 'indexedAt' => 'string', 'createdAt' => 'string', 'viewer' => 'array', 'labels' => 'array', 'verification' => 'array', 'status' => 'array']]];
    public const searchActorsTypeaheadResponse = ['actors' => [['did' => 'string', 'handle' => 'string', 'displayName' => 'string', 'avatar' => 'string', 'associated' => 'array', 'viewer' => 'array', 'labels' => 'array', 'createdAt' => 'string', 'verification' => 'array', 'status' => 'array']]];
