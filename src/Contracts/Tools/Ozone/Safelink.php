...
interface Safelink
{
    ...
    public const addRuleResponse = ['id' => 'int', 'eventType' => 'mixed', 'url' => 'string', 'pattern' => 'mixed', 'action' => 'mixed', 'reason' => 'mixed', 'createdBy' => 'string', 'createdAt' => 'string', 'comment' => 'string'];
    public const queryEventsResponse = ['cursor' => 'string', 'events' => [['id' => 'int', 'eventType' => 'array', 'url' => 'string', 'pattern' => 'array', 'action' => 'array', 'reason' => 'array', 'createdBy' => 'string', 'createdAt' => 'string', 'comment' => 'string']]];
    public const queryRulesResponse = ['cursor' => 'string', 'rules' => [['url' => 'string', 'pattern' => 'array', 'action' => 'array', 'reason' => 'array', 'comment' => 'string', 'createdBy' => 'string', 'createdAt' => 'string', 'updatedAt' => 'string']]];
    public const removeRuleResponse = ['id' => 'int', 'eventType' => 'mixed', 'url' => 'string', 'pattern' => 'mixed', 'action' => 'mixed', 'reason' => 'mixed', 'createdBy' => 'string', 'createdAt' => 'string', 'comment' => 'string'];
    public const updateRuleResponse = ['id' => 'int', 'eventType' => 'mixed', 'url' => 'string', 'pattern' => 'mixed', 'action' => 'mixed', 'reason' => 'mixed', 'createdBy' => 'string', 'createdAt' => 'string', 'comment' => 'string'];
    ...
    #[Output(self::queryRulesResponse)]
    ...
    #[Output(self::removeRuleResponse)]
    ...
    #[Output(self::updateRuleResponse)]
