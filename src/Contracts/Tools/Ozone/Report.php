...
interface Report
{
    ...
    public function queryReports(#[KnownValues(['open', 'closed', 'escalated', 'queued', 'assigned'])] string $status, ?int $queueId = null, ?array $reportTypes = null, #[Format('uri')] ?string $subject = null, #[Format('did')] ?string $did = null, #[KnownValues(['account', 'record', 'message', 'conversation'])] ?string $subjectType = null, #[Format('nsid')] ?array $collections = null, #[Format('datetime')] ?string $reportedAfter = null, #[Format('datetime')] ?string $reportedBefore = null, ?bool $isMuted = null, #[Format('did')] ?string $assignedTo = null, ?string $sortField = 'createdAt', ?string $sortDirection = 'desc', ?int $limit = 50, ?string $cursor = null);
