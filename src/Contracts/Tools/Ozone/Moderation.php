...
interface Moderation
{
    ...
    public const emitEventResponse = ['id' => 'int', 'event' => 'array', 'subject' => 'array', 'subjectBlobCids' => 'array', 'createdBy' => 'string', 'createdAt' => 'string', 'creatorHandle' => 'string', 'subjectHandle' => 'string', 'modTool' => 'mixed'];
    public const getEventResponse = ['id' => 'int', 'event' => 'array', 'subject' => 'array', 'subjectBlobs' => [[]], 'createdBy' => 'string', 'createdAt' => 'string', 'modTool' => 'mixed'];
    ...
    public const getSubjectsResponse = ['subjects' => [['type' => 'array', 'subject' => 'string', 'status' => 'array', 'repo' => 'array', 'profile' => 'array', 'record' => 'array']]];
    public const queryEventsResponse = ['cursor' => 'string', 'events' => [['id' => 'int', 'event' => 'array', 'subject' => 'array', 'subjectBlobCids' => 'array', 'createdBy' => 'string', 'createdAt' => 'string', 'creatorHandle' => 'string', 'subjectHandle' => 'string', 'modTool' => 'array']]];
    ...
    #[Output(self::getSubjectsResponse)]
