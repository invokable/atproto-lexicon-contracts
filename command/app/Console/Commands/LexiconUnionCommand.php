...
/**
 * Generate php abstract Union class from lexicon json.
 *
 * ```
 ...
 * ```
 */
class LexiconUnionCommand extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'bluesky:lexicon-union';
     ...
     * @var string
     */
    protected $description = 'Generate php abstract Union class from lexicon json';
    ...
    {
        $this->php_path = realpath(__DIR__.'/../../../../src/Union/');
    ...
    protected function getProperties(array $json, string $id): string
    {
        ...
        $properties = Arr::get($json, 'defs.main.properties');
    ...
    protected function save(array $json, string $id, string $property): void
    {
        ...
        // "App/Bsky/Embed/AbstractExternal"
        ...
        $tmp = File::get(realpath(__DIR__.'/stubs/lexicon-union.stub'));
